...
def main():
    ...
    if args.evaluate:
        ...
        eval_metrics = validate(-1,model, loader_eval, validate_loss_fn, args, amp_autocast=amp_autocast)
    ...
    try:
        ...
        for epoch in range(args.train_before_sample):
            print(epoch)
        ...
        for epoch in range(start_epoch+args.train_before_sample, num_epochs+args.train_before_sample):
...
def train_one_epoch(
    ...
    writer.add_scalar('Train/Loss',losses_m.avg,epoch+1)
...
def validate(epoch,model, loader, loss_fn, args, amp_autocast=suppress, log_suffix=''):
    ...
    writer.add_scalar('Test/Loss',losses_m.avg,epoch+1)
    writer.add_scalar('Test/acc',top1_m.avg,epoch+1)
    writer.add_scalar('Test/Purned',pruned*100,epoch+1)
